...
drop table if exists naver_top_ranked_movie_list;
...
create table movie(
    ...
    reporter_pointer float default 0,
    netizen_point float,
    nationality varchar(30),
    running_time int,
    opening_date date,  -- python 내에서 date에 맞게 parsing하기
    domestic_rate varchar(10), -- 등급이 없을수도 있음
